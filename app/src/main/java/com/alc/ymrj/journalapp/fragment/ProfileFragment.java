...
import com.alc.ymrj.journalapp.LoginActivity;
import com.alc.ymrj.journalapp.MainActivity;
...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTvPhone = (TextView) view.findViewById(R.id.tv_user_phone);
        mTvProviderID = (TextView) view.findViewById(R.id.tv_user_provider_id);

        mTvName.setText(mFirebaseUser.getDisplayName());
        mTvEmail.setText(mFirebaseUser.getEmail());
        mTvPhone.setText(mFirebaseUser.getPhoneNumber());
        mTvProviderID.setText(mFirebaseUser.getProviderId());
